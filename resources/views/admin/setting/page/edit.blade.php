                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="page_position" id="page_position" class="form-control">
                                            <option value="1" {{ $page->page_position == 1 ? 'selected' : null }}>Line
                                                one</option>
                                            <option value="2" {{ $page->page_position == 2 ? 'selected' : null }}>Line
                                                two</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="page_title" placeholder="Page title"
                                            name="page_title" value="{{ $page->page_title }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="page_description">Page Description</label>
                                        <textarea type="text" class="form-control" id="summernote" placeholder="Page description" name="page_description">{{ $page->page_description }}</textarea>
                                    </div>
                                </div>
