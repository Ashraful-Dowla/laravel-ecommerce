            ...
            <div class="row">
                ...
                <div class="col-lg-4 order-3">
                    <div class="product_description">
                        ...
                        <div class="product_price mt-4">{{ $setting->currency }}{{ $campaign_product->price }}
                        </div>
                        <div class="order_info d-flex flex-row">
                            <form action="{{ route('cart.add.quick.view') }}" method="post" id="add_cart_form">
                                @csrf
                                <input type="hidden" name="id" value="{{ $product->id }}">
                                <input type="hidden" name="campaign_id" value="{{ $campaign_product->campaign_id }}">
                                                ...
                                                <div class="owl-item">
                                                    <div
                                                        ...
                                                        <div class="viewed_image"><img
                                                                src="{{ asset($row->product->product_thumbnail) }}"
                                                                alt=""></div>
                                                        <div class="viewed_content text-center">
                                                            <div class="viewed_price">
                                                                <span>{{ $setting->currency }}{{ $row->product->product_selling_price }}</span>
                                                            </div>
                                                            <div class="viewed_name"><a
                                                                    href="{{ route('product.details', $row->product->product_slug) }}">{{ substr($row->product_name, 0, 15) }}</a>
                                                            </div>
                                                        </div>
                                                        <ul class="item_marks">
