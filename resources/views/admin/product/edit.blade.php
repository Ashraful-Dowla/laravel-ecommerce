                                ...
                                <div class="card-body">
                                                ...
                                                @foreach ($categories as $category)
                                                    ...
                                                    @foreach ($subcategories as $subcategory)
                                                        <option value="{{ $subcategory->id }}"
                                                            {{ $subcategory->id == $product->subcategory_id ? 'selected' : null }}>
                                            ...
                                            <select class="form-control" name="childcategory_id" id="childcategory_id">
                                                ...
                                                @foreach ($childcategories as $childcategory)
                                                    <option value="{{ $childcategory->id }}"
                                                        {{ $childcategory->id == $product->childcategory_id ? 'selected' : null }}>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="brand_id">
                                                ...
                                                @foreach ($brands as $row)
                                                    <option value="{{ $row->id }}"
                                                        {{ $row->id == $product->brand_id ? 'selected' : null }}>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="pickup_point_id">
                                                ...
                                                @foreach ($pickup_point as $row)
                                                    <option value="{{ $row->id }}"
                                                        {{ $row->id == $product->pickup_point_id ? 'selected' : null }}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="product_tags" class="form-control"
                                                value="{{ $product->product_tags }}" name="tags" data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="warehouse_id">
                                                ...
                                                @foreach ($warehouses as $row)
                                                    <option value="{{ $row->id }}"
                                                        {{ $row->id == $product->warehouse_id ? 'selected' : null }}>
                                                        {{ $row->warehouse_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="product_stock_quantity"
                                                value="{{ $product->product_stock_quantity }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea class="form-control textarea" id="summernote" name="product_description">{{ $product->product_description }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card p-4">
                                        ...
                                        <input type="checkbox" name="product_featured" value="0"
                                            {{ $product->product_featured == 1 ? 'checked' : null }} data-bootstrap-switch
                                    ...
                                    <div class="card p-4">
                                        ...
                                        <input type="checkbox" name="product_today_deal" value="0"
                                            {{ $product->product_today_deal == 1 ? 'checked' : null }}
                                    ...
                                    <div class="card p-4">
                                        ...
                                        <input type="checkbox" name="product_status" value="0" data-bootstrap-switch
                                            {{ $product->product_status == 1 ? 'checked' : null }} data-off-color="danger"
                                            data-on-color="success">
                                    </div>
