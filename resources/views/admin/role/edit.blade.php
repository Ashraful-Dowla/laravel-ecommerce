                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            <label for="exampleInputEmail1">Employee Name <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" class="form-control" name="name"
                                                value="{{ $user->name }}" required="">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="exampleInputPassword1">Employee Email <span
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            <input type="checkbox" name="category" value="1"
                                                @if ($user->category == 1) checked @endif>
                                        </div>
                                        <div class="col-3">
                                            <h6>Product</h6>
                                            <input type="checkbox" name="product" value="1"
                                                @if ($user->product == 1) checked @endif>
                                        </div>
                                        <div class="col-3">
                                            <h6>Offer</h6>
                                            <input type="checkbox" name="offer" value="1"
                                                @if ($user->offer == 1) checked @endif>
                                        </div>
                                        <div class="col-3">
                                            <h6>Order</h6>
                                            <input type="checkbox" name="order" value="1"
                                                @if ($user->order == 1) checked @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            <input type="checkbox" name="pickup" value="1"
                                                @if ($user->pickup == 1) checked @endif>
                                        </div>
                                        <div class="col-3">
                                            <h6>Tickets</h6>
                                            <input type="checkbox" name="ticket" value="1"
                                                @if ($user->ticket == 1) checked @endif>
                                        </div>
                                        <div class="col-3">
                                            <h6>Contact</h6>
                                            <input type="checkbox" name="contact" value="1"
                                                @if ($user->contact == 1) checked @endif>
                                        </div>
                                        <div class="col-3">
                                            <h6>Report</h6>
                                            <input type="checkbox" name="report" value="1"
                                                @if ($user->report == 1) checked @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input type="checkbox" name="user_role" value="1"
                                                @if ($user->user_role == 1) checked @endif>
                                        </div>
                                        <div class="col-3">
                                            <h6>blog</h6>
                                            <input type="checkbox" name="blog" value="1"
                                                @if ($user->blog == 1) checked @endif>
                                        </div>
